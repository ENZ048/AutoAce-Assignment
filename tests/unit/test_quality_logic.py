...
def test_clipping_overrides_everything():
    rating, override = rate_quality(
        clipping_ratio=0.08,
        dropouts_per_min=10.0,
        rolloff_hz=200.0,
        speech_rms_dbfs=-60.0,
        pesq=1.0,
        snr_db=20.0,
    )
